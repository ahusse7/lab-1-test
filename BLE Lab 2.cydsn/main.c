...
int main()
{
    ...
    /* ADD_CODE - Start the BLE component and register StackEventHandler function */
    CyBle_Start(StackEventHandler);
    
    /* ADD_CODE - Start the PWM component */
    PWM_Start();
    ...
    while(1)
    {
        /* ADD_CODE - Process all the pending BLE tasks. This single API call to 
